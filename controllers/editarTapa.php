...
if ($resultado) {
header("location:../admin/control-tapas.php?mensaje=1"); // Error al cargar la imagen
exit;
// echo "Registro actualizado con éxito.";
} else {
header("location:../admin/control-tapas.php?mensaje=2"); // Error al cargar la imagen
exit;
// echo "No se pudo actualizar el registro.";
}
} catch (Exception $e) {
header("location:../admin/control-tapas.php?mensaje=3"); // Error al cargar la imagen
exit;
