        ...
        <div class="row">
            ...
            <div class="col-lg-11" style=" padding-bottom: 1%">
                <form id="formulario"
                    ...
                    action="../controllers/editarproducto.php?id=<?php echo $filtro;?>" method="post"
                        ...
                        <div class="formulario__grupo__input row d-flex align-items-center ">
                            <div id="grupo__nombre" class="inputsection col-md-4">
                                ...
                                <div class="formulario__grupo__input">
                                    <input id="nombre" type="text" class="formulario--input" name="nombre"
                                        value="<?php echo $resultados[0]["nombre"];?>" placeholder="Ej (GLV-101)"
                                        autocomplete="off">
                            ...
                            <div id="grupo__peso" class="inputsection col-md-8">
                                ...
                                <div class="formulario__grupo__input">
                                    <input id="descripcion" type="text" maxlength="9" class="formulario--input"
                                        ...
                                        value="<?php echo $resultados[0]["descripcion"];?>" autocomplete="off">
                                    <i class="formulario__validación--estado fa-regular fa-circle-xmark"></i>
                                </div>
                                <span>
                                    <p class="texto__error">El nombre del cliente solo puede contener de 3 a
                            ...
                            <div id="grupo__precio" class="inputsection col-md-4">
                                ...
                                <div class="formulario__grupo__input">
                                    <input id="capacidad" type="text" maxlength="9" class="formulario--input"
                                        value="<?php echo $resultados[0]["capacidad"];?>" name="capacidad"
                            ...
                            <div id="grupo__precio" class="inputsection col-md-4">
                                ...
                                <div class="formulario__grupo__input">
                                    <input id="precio_mayor" type="text" maxlength="9" class="formulario--input"
                                        value="<?php echo $resultados[0]["precio_mayor"];?>" name="precio_mayor"
                            ...
                            <div id="grupo__precio" class="inputsection col-md-4">
                                ...
                                <div class="formulario__grupo__input">
                                    <input id="precio_detal" type="text" maxlength="9" class="formulario--input"
                                        value="<?php echo $resultados[0]["precio_detal"];?>" name="precio_detal"
                            ...
                            <div id="grupo__cantidad" class="inputsection col-md-4">
                                ...
                                <div class="formulario__grupo__input">
                                    <input id="disponible" type="number" maxlength="9" class="formulario--input"
                                        value="<?php echo $resultados[0]["cantidad_disponible"];?>" name="disponible"
                            ...
                            <div id="grupo__segunda" class="inputsection col-md-4">
                                ...
                                <div class="formulario__grupo__input">
                                    <input id="inventario" type="number" maxlength="9" class="formulario--input"
                                        value="<?php echo $resultados[0]["inventario"];?>" name="inventario"
                            ...
                            <div class=" inputsection md-4 d-flex justify-content-end align-items-center mt-5">
                                <button id="" class="d btn-formulario  btn btn-g btn-submit d-flex"
                                    style="background-color: #405788; color: #fff" type="submit">Editar Frasco <i
