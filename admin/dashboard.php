...
.chart-container.canvas-container {
    height: 100%;
    flex-grow: 1;
    /* Permite ajustar la altura a medida que el contenido varía */
}
        ...
        <main class="main-content">
            <div class="row">
                ...
                <div class="col-lg-12" style="padding-left: 13rem;">
                    <h1 style="color: #405788">Bienvenido al Panel Administrativo</h1>
                </div>
    ...
    async function fetchProducts() {
        try {
            const response = await fetch(
                'http://localhost/Glassvenca3/models/apis/apisGetProductos.php'
                ); // Reemplaza 'api/obtener_productos.php' con la ruta a tu archivo PHP
