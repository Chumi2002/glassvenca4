...
<div class="container desplazamiento-derecha">
    ...
    <form action="../controllers/registro_usuario.php" method="post">
        ...
        <div class="consent">
            ...
            <label for="terms">Al firmar y hacer clic en Enviar, acepta nuestra Política de privacidad y Términos de
                uso. <a href="#">Privacy Policy</a> and <a href="#">Terms of Use</a>.</label>
        </div>
